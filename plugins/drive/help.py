...
from info import Messages as tr
from pyrogram.types import InlineKeyboardMarkup, InlineKeyboardButton


@Client.on_message(filters.private & filters.incoming & filters.command(['start_drive']), group=2)
...
@Client.on_message(filters.private & filters.incoming & filters.command(['helpd']), group=2)
...
help_callback_filter = filters.create(lambda _, __, query: query.data.startswith('helpd+'))
